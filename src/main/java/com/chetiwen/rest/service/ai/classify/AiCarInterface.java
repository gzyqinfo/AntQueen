...
@Path("/ai")
public class AiCarInterface {
    private static Logger logger = LoggerFactory.getLogger(AiCarInterface.class);
    // 请求url
    private String REQUEST_URL = "https://aip.baidubce.com/rest/2.0/image-classify/v1/car";
    ...
    @POST
    @Path("/image-classify/car")
    @Consumes("application/json")
    @Produces("application/json;charset=UTF-8")
    public Response processRequest(Object requestObject) {
        logger.info("---------------------------------------------------------------------------------------------------");
        logger.info("Received Car Classify request.");
