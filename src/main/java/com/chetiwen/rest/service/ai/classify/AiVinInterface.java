...
@Path("/ai")
public class AiVinInterface {
    private static Logger logger = LoggerFactory.getLogger(AiVinInterface.class);
    // 请求url
    private String REQUEST_URL = "https://aip.baidubce.com/rest/2.0/ocr/v1/vin_code";
    ...
    @POST
    @Path("/image-classify/vin")
    @Consumes("application/json")
    @Produces("application/json;charset=UTF-8")
    public Response processRequest(Object requestObject) {
        logger.info("---------------------------------------------------------------------------------------------------");
        logger.info("Received VIN Classify request.");
