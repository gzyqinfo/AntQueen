...
public class GetOrderInterface {
    ...
    public Response processRequest(Object requestObject) throws Exception {
        ...
        try {
            ...
            TransLogAccessor.getInstance().AddTransLog(originalRequest, JSONObject.toJSONString(requestObject), ConstData.CLIENT_GETORDER_REQUEST);
            ...
            TransLogAccessor.getInstance().AddTransLog(originalRequest, antResponse.toJSONString(), ConstData.ANTQUEEN_GETORDER_RESPONSE);
    ...
    public JSONObject askSource(Object requestObject, AntRequest originalRequest, String sourceOrderNo) throws Exception {
        ...
        TransLogAccessor.getInstance().AddTransLog(originalRequest, jsonRequest.toString(), ConstData.ANTQUEEN_GETORDER_REQUEST);
