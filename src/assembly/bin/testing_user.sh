...
echo -e "Starting the Testing Environment User Operation ...\c"
java $JAVA_OPTS $JAVA_MEM_OPTS $JAVA_DEBUG_OPTS $JAVA_JMX_OPTS -classpath $CONF_DIR:$LIB_JARS com.chetiwen.server.TestingEnvUser
